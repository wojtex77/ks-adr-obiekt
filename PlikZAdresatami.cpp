...
int PlikZAdresatami::edytujPlikTekstowyAdresatow(int idAdresata, string liniaZDanymiAdresataOddzielonePionowymiKreskami)
{
...
void PlikZAdresatami::zaktualizujDaneEdytowanegoAdresata(Adresat adresat)
{
    ...
    liniaZDanymiAdresata = zamienDaneAdresatowNaLinieZDanymiOddzielonaPionowymiKreskami(adresat);
    edytujPlikTekstowyAdresatow(adresat.pobierzIdAdresata(),liniaZDanymiAdresata);
